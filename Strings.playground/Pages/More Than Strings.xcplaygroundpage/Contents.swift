...
let story = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(adjective) \(noun1). They went to the \(noun2) \(place) feeling very \(postitive). But then they felt \(negative). They were all out of \(noun3)!"
