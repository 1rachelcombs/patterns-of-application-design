...
let totaltime = brushTeeth + walkdogs + shower + chooseclothes + makecofee + fixlunch
...
let haveto = brushTeeth + walkdogs + shower + chooseclothes

let liketo = makecofee + fixlunch
